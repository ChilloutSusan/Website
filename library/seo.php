...
<?php
    ...
    $twitter_account = apply_filters('theme_twitter_account', '@pantsuvr');
    if ($twitter_account) {
?>
...
function theme_ld_meta_tags() {
    ...
    $social_links = apply_filters('theme_social_links', array("https://www.youtube.com/@PantsuVR","twitter.com/pantsuvr","https://patreon.com/PantsuVR"));
